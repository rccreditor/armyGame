...
interface StartScreenLevel3Props {
  onStartGame: () => void;
}

const StartScreenLevel3: React.FC<StartScreenLevel3Props> = ({ onStartGame }) => {
  return (
        ...
        <div className="mcq-dialog p-12">
          ...
          <div className="mb-8">
            ...
            <div className="w-full h-2 bg-primary/20 rounded">
              <div className="w-1 h-full bg-primary rounded animate-pulse" />
            </div>
          </div>
          ...
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-primary-foreground mb-4">
              MISSION 3 : Secure the Plan
            </h2>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Enemy forces have established a stronghold in the treacherous mountain terrain. You must lead a specialized unit to dislodge them, facing extreme conditions and fortified positions.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
            <div className="bg-primary/10 p-4 rounded-lg">
              ...
              <div className="text-sm font-bold text-primary-foreground">6 TARGETS</div>
...
export default StartScreenLevel3;