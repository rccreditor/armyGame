...
interface StartScreenLevel2Props {
  onStartGame: () => void;
}

const StartScreenLevel2: React.FC<StartScreenLevel2Props> = ({ onStartGame }) => {
  return (
        ...
        <div className="mcq-dialog p-12">
          ...
          <div className="mb-8">
            ...
            <div className="w-full h-2 bg-primary/20 rounded">
              <div className="w-1/2 h-full bg-primary rounded animate-pulse" />
            </div>
          </div>
          ...
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-primary-foreground mb-4">
              MISSION 2 : Needs Recon
            </h2>
            <p className="text-lg text-muted-foreground leading-relaxed">
              The enemy has taken positions in a dense urban environment. Navigate the streets carefully, identify threats, and engage with precision. Civilian casualties must be avoided at all costs.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
            <div className="bg-primary/10 p-4 rounded-lg">
              ...
              <div className="text-sm font-bold text-primary-foreground">5 TARGETS</div>
          ...
          {/* <div className="mt-6 text-sm text-muted-foreground">
            Mission 3: The Urban Combat • Rank: Soldier
          </div> */}
        </div>
      </div>
    </div>
...
export default StartScreenLevel2;